        ...
        <Grid container justify='center' alignItems="stretch" spacing={8} xs={12}>
          ...
          <Grid item xs={10}>
            <Paper className={classes.paper}>
              ...
              <Link href='https://www.77onlineshop.eu/$WS/77onlineshop/websale8_shop-77onlineshop/produkte/medien/bilder/gross/21031469.jpg' target="_blank" rel="noreferrer">https://www.77onlineshop.eu/$WS/77onlineshop/websale8_shop-77onlineshop/produkte/medien/bilder/gross/21031469.jpg</Link>
            </Paper>
          </Grid>
